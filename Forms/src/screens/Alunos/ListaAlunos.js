...
export default function ListaPessoas({ navigation, route }) {
  ...
  /*function getImc(pessoa) {
    const curso = parseFloat(pessoa.curso)
    const turno = parseFloat(pessoa.turno)
  ...
  return (
    <View style={styles.container}>
      ...
      <Text variant='titleLarge' style={styles.title} >Controle de Alunos</Text>
